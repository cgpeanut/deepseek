...
dataframe = pd.read_csv('/home/roxasrr/code/deepseek/bs.csv', usecols=[0], engine='python')
dataframe = pd.read_json('/home/roxasrr/code/deepseek/powerball_numbers.json', usecols=[0], engine='python')
